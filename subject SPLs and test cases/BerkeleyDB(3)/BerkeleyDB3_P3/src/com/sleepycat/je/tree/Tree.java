      ...
      allRightSideDescent=true;
{
 ...
 while (!(parent instanceof BIN));
  ...
  protected void hook660(  LN newLN,  long binNid,  DBIN dupBin,  long newLsn) throws DatabaseException {
   ...
   private void  hook661__wrappee__base  () throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }
  ...
  protected void hook661() throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    ...
    hook661__wrappee__base();
  }

	
   private void  hook662__wrappee__base  (  IN curRoot,  long curRootLsn,  long logLsn,  IN newRoot) throws DatabaseException {
  }
  ...
  protected void hook662(  IN curRoot,  long curRootLsn,  long logLsn,  IN newRoot) throws DatabaseException {
    ...
    hook662__wrappee__base(curRoot,curRootLsn,logLsn,newRoot);
  }

	
   private void  hook663__wrappee__base  (  DIN curRoot,  DIN newRoot,  long curRootLsn,  long logLsn) throws DatabaseException {
  }
  ...
  protected void hook663(  DIN curRoot,  DIN newRoot,  long curRootLsn,  long logLsn) throws DatabaseException {
    ...
    hook663__wrappee__base(curRoot,newRoot,curRootLsn,logLsn);
  }

	
   private void  hook664__wrappee__base  (  LN newLN,  DIN dupRoot,  DBIN dupBin,  BIN bin,  LN existingLN,  DupCountLN dupCountLN,  long dbinLsn,  long dinLsn,  long dupCountLsn,  long newLsn) throws DatabaseException {
  }
  ...
  protected void hook664(  LN newLN,  DIN dupRoot,  DBIN dupBin,  BIN bin,  LN existingLN,  DupCountLN dupCountLN,  long dbinLsn,  long dinLsn,  long dupCountLsn,  long newLsn) throws DatabaseException {
    ...
    hook664__wrappee__base(newLN,dupRoot,dupBin,bin,existingLN,dupCountLN,dbinLsn,dinLsn,dupCountLsn,newLsn);
  }

	
   private void  hook665__wrappee__base  (  IN subtreeRoot) throws DatabaseException {
  }
  ...
  protected void hook665(  IN subtreeRoot) throws DatabaseException {
    ...
    hook665__wrappee__base(subtreeRoot);
  }
