 ...
 */
  public boolean equals(  Object obj){
	  //**Space({P2,P3,P4,P6}) - delete
	  if (this == obj) {
	//**Space({P2,P3,P4,P6}) - add
//    if (this != obj) {
      return true;
    }
	//**Space({P2,P3,P4,P6}) - delete
 ...
 */
   private static void  trace__wrappee__LoggingSevere  (  EnvironmentImpl envImpl,  String sourceClass,  String sourceMethod,  String msg,  Throwable t){
  }
 ...
 */
  public static void trace(  EnvironmentImpl envImpl,  String sourceClass,  String sourceMethod,  String msg,  Throwable t){
    ...
    trace__wrappee__LoggingSevere(envImpl,sourceClass,sourceMethod,msg,t);
  }
