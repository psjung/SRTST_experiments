 ...
 */
  public static String getJavaCommand(  Class cls){
   ...
   private static void  hook853__wrappee__base  (  EnvironmentConfig config) throws DatabaseException {
  }
  ...
  protected static void hook853(  EnvironmentConfig config) throws DatabaseException {
    ...
    hook853__wrappee__base(config);
  }

	
   private static void  hook854__wrappee__base  (  EnvironmentConfig config) throws DatabaseException {
  }
  ...
  protected static void hook854(  EnvironmentConfig config) throws DatabaseException {
    ...
    hook854__wrappee__base(config);
  }

	
   private static void  hook855__wrappee__base  (  EnvironmentConfig config) throws DatabaseException {
  }
