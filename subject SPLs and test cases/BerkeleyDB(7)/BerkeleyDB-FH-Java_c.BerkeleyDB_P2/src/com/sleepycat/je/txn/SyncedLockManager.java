 ...
 */
  protected void dumpLockTable(  LockStats stats) throws DatabaseException {
   ...
   private void  hook782__wrappee__base  (  Long nodeId,  Locker locker,  LockType type,  boolean nonBlockingRequest,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook782__wrappee__base(nodeId,locker,type,nonBlockingRequest,lockTableIndex);
    }
  }

	
   private void  hook783__wrappee__base  (  String lockOrTxn,  Locker locker,  long nodeId,  LockType type,  LockGrantType grantType,  Lock useLock,  long timeout,  long start,  long now,  DatabaseImpl database,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook783__wrappee__base(lockOrTxn,locker,nodeId,type,grantType,useLock,timeout,start,now,database,lockTableIndex);
    }
  }

	
   private void  hook784__wrappee__base  (  long nodeId,  Lock lock,  Locker locker,  boolean removeFromLocker,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook784__wrappee__base(nodeId,lock,locker,removeFromLocker,lockTableIndex);
    }
  }

	
   private void  hook785__wrappee__base  (  long nodeId,  Locker owningLocker,  Locker destLocker,  boolean demoteToRead,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook785__wrappee__base(nodeId,owningLocker,destLocker,demoteToRead,lockTableIndex);
    }
  }

	
   private void  hook786__wrappee__base  (  long nodeId,  Locker owningLocker,  Locker[] destLockers,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook786__wrappee__base(nodeId,owningLocker,destLockers,lockTableIndex);
    }
  }

	
   private void  hook787__wrappee__base  (  long nodeId,  Locker locker,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook787__wrappee__base(nodeId,locker,lockTableIndex);
    }
  }

	
   private void  hook788__wrappee__base  (  Long nodeId,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook788__wrappee__base(nodeId,lockTableIndex);
    }
  }

	
   private void  hook789__wrappee__base  (  Long nodeId,  Locker locker,  LockType type,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook789__wrappee__base(nodeId,locker,type,lockTableIndex);
    }
  }

	
   private void  hook790__wrappee__base  (  Long nodeId,  Locker locker,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook790__wrappee__base(nodeId,locker,lockTableIndex);
    }
  }

	
   private void  hook791__wrappee__base  (  Long nodeId,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook791__wrappee__base(nodeId,lockTableIndex);
    }
  }

	
   private void  hook792__wrappee__base  (  Long nodeId,  int lockTableIndex){
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook792__wrappee__base(nodeId,lockTableIndex);
    }
  }

	
   private void  hook793__wrappee__base  (  Long nodeId,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook793__wrappee__base(nodeId,lockTableIndex);
    }
  }

	
   private void  hook794__wrappee__base  (  Long nodeId,  Locker locker,  LockType type,  boolean flushFromWaiters,  MemoryBudget mb,  int lockTableIndex) throws DatabaseException {
...
synchronized (lockTableLatches[lockTableIndex]) {
      hook794__wrappee__base(nodeId,locker,type,flushFromWaiters,mb,lockTableIndex);
    }
  }

	
   private void  hook795__wrappee__base  (  LockStats stats,  int i) throws DatabaseException {
...
synchronized (lockTableLatches[i]) {
      hook795__wrappee__base(stats,i);
    }
  }
