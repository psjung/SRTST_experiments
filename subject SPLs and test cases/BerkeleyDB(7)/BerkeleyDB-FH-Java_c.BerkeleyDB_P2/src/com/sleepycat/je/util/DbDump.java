...
public   class  DbDump {
  ...
  protected void openEnv(  boolean doRecovery) throws DatabaseException {
   ...
   private void  dump__wrappee__base  () throws IOException, DatabaseException {
    openEnv(true);
    this.hook834();
  ...
  protected void dumpOne(  PrintStream o,  byte[] ba,  boolean formatUsingPrintable){
   ...
   private void  hook834__wrappee__base  () throws IOException, DatabaseException {
  }
