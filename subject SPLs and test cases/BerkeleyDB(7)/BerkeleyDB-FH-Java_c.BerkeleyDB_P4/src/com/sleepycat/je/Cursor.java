 ...
 */
  ...
  private void traceCursorImpl(  StringBuffer sb){
   ...
   private void  hook0__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook0() throws DatabaseException {
    trace(Level.FINEST,"Cursor.count: ",null);
    hook0__wrappee__base();
  }

	
   private void  hook1__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook1() throws DatabaseException {
    trace(Level.FINEST,"Cursor.delete: ",null);
    hook1__wrappee__base();
  }

	
   private void  hook2__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
  }
  ...
  protected void hook2(  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
    ...
    hook2__wrappee__base(key,data);
  }

	
   private void  hook3__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
  }
  ...
  protected void hook3(  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
    ...
    hook3__wrappee__base(key,data);
  }

	
   private void  hook4__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
  }
  ...
  protected void hook4(  DatabaseEntry key,  DatabaseEntry data) throws DatabaseException {
    ...
    hook4__wrappee__base(key,data);
  }

	
   private void  hook5__wrappee__base  (  DatabaseEntry data) throws DatabaseException {
  }

	
  protected void hook5(  DatabaseEntry data) throws DatabaseException {
    trace(Level.FINEST,"Cursor.putCurrent: ",null,data,null);
    hook5__wrappee__base(data);
  }

	
   private void  hook6__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook6(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getCurrent: ",lockMode);
    hook6__wrappee__base(lockMode);
  }

	
   private void  hook7__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook7(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getFirst: ",lockMode);
    hook7__wrappee__base(lockMode);
  }

	
   private void  hook8__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook8(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getLast: ",lockMode);
    hook8__wrappee__base(lockMode);
  }

	
   private void  hook9__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook9(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getNext: ",lockMode);
    hook9__wrappee__base(lockMode);
  }

	
   private void  hook10__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook10(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getNextDup: ",lockMode);
    hook10__wrappee__base(lockMode);
  }

	
   private void  hook11__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook11(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getNextNoDup: ",lockMode);
    hook11__wrappee__base(lockMode);
  }

	
   private void  hook12__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook12(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getPrev: ",lockMode);
    hook12__wrappee__base(lockMode);
  }

	
   private void  hook13__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook13(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getPrevDup: ",lockMode);
    hook13__wrappee__base(lockMode);
  }

	
   private void  hook14__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook14(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"Cursor.getPrevNoDup: ",lockMode);
    hook14__wrappee__base(lockMode);
  }

	
   private void  hook15__wrappee__base  (  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook15(  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
    ...
    hook15__wrappee__base(key,lockMode);
  }

	
   private void  hook16__wrappee__base  (  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook16(  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
    ...
    hook16__wrappee__base(key,lockMode);
  }

	
   private void  hook17__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook17(  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook17__wrappee__base(key,data,lockMode);
  }

	
   private void  hook18__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook18(  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook18__wrappee__base(key,data,lockMode);
  }

	
   private void  hook19__wrappee__base  (  CursorImpl dup) throws DatabaseException {
  }

	
  protected void hook19(  CursorImpl dup) throws DatabaseException {
    dup.latchBINs();
    hook19__wrappee__base(dup);
  }

	
   private void  hook20__wrappee__base  (  CursorImpl origCursor,  CursorImpl dup) throws DatabaseException {
  }
  ...
  protected void hook20(  CursorImpl origCursor,  CursorImpl dup) throws DatabaseException {
    ...
    hook20__wrappee__base(origCursor,dup);
  }

	
   private void  hook21__wrappee__base  (  CursorImpl origCursor) throws DatabaseException {
  }
  ...
  protected void hook21(  CursorImpl origCursor) throws DatabaseException {
    ...
    hook21__wrappee__base(origCursor);
  }

	
   private void  hook22__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook22() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0 : LatchSupport.latchesHeldToString();
    hook22__wrappee__base();
  }

	
   private void  hook23__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook23() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 1 : LatchSupport.latchesHeldToString();
    hook23__wrappee__base();
  }

	
   private void  hook24__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook24() throws DatabaseException {
    cursorImpl.releaseBINs();
    hook24__wrappee__base();
  }

	
   private void  hook25__wrappee__base  (  CursorImpl dup,  DatabaseEntry key,  DatabaseEntry data,  LockType searchLockType,  LockType advanceLockType,  SearchMode searchMode,  boolean advanceAfterRangeSearch,  OperationStatus status,  boolean keyChange) throws DatabaseException {
  ...
  protected void hook25(  CursorImpl dup,  DatabaseEntry key,  DatabaseEntry data,  LockType searchLockType,  LockType advanceLockType,  SearchMode searchMode,  boolean advanceAfterRangeSearch,  OperationStatus status,  boolean keyChange) throws DatabaseException {
    try {
      hook25__wrappee__base(dup,key,data,searchLockType,advanceLockType,searchMode,advanceAfterRangeSearch,status,keyChange);
    }
  finally {
      cursorImpl.releaseBINs();
   ...
   private void  hook26__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook26() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook26__wrappee__base();
  }

	
   private void  hook27__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook27() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook27__wrappee__base();
  }

	
   private void  hook28__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook28() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook28__wrappee__base();
  }

	
   private void  hook29__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook29() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook29__wrappee__base();
  }

	
   private void  hook30__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook30() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook30__wrappee__base();
  }

	
   private void  hook31__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook31() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook31__wrappee__base();
  }

	
   private void  hook32__wrappee__base  (  CursorImpl origCursor) throws DatabaseException {
  }

	
  protected void hook32(  CursorImpl origCursor) throws DatabaseException {
    origCursor.releaseBINs();
    hook32__wrappee__base(origCursor);
  }

	
   private void  hook33__wrappee__base  (  CursorImpl origCursor) throws DatabaseException {
  }

	
  protected void hook33(  CursorImpl origCursor) throws DatabaseException {
    origCursor.latchBINs();
    hook33__wrappee__base(origCursor);
  }

	
   private void  hook34__wrappee__base  (  CursorImpl origCursor) throws DatabaseException {
  }

	
  protected void hook34(  CursorImpl origCursor) throws DatabaseException {
    origCursor.releaseBINs();
    hook34__wrappee__base(origCursor);
  }

	
   private void  hook35__wrappee__base  (  CursorImpl origCursor) throws DatabaseException {
  }

	
  protected void hook35(  CursorImpl origCursor) throws DatabaseException {
    origCursor.latchBINs();
    hook35__wrappee__base(origCursor);
  }

	
   private void  hook36__wrappee__base  (  DatabaseImpl dbImpl) throws DatabaseException {
  }

	
  protected void hook36(  DatabaseImpl dbImpl) throws DatabaseException {
    this.logger=dbImpl.getDbEnvironment().getLogger();
    hook36__wrappee__base(dbImpl);
  }
