        ...
        isDupCountLN=ln.containsDuplicates();
{
     ...
     private void  execute__wrappee__Statistics  () throws DatabaseException {
	...
	protected LookAheadCache lookAheadCache;
     ...
     private void  hook117__wrappee__LookAHEADCache  () throws DatabaseException {
    }
    ...
    protected void hook117() throws DatabaseException {
      ...
      _this.nLNsCleanedThisRun++;
      hook117__wrappee__LookAHEADCache();
    }
