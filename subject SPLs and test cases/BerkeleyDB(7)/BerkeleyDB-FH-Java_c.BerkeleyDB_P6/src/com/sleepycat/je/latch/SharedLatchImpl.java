 ...
 */
  ...
  public synchronized boolean isWriteLockedByCurrentThread(){
   ...
   private void  hook429__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }

	
  protected void hook429() throws DatabaseException, InterruptedException {
    stats.nAcquiresNoWaiters++;
    hook429__wrappee__Latches();
  }

	
   private void  hook430__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }

	
  protected void hook430() throws DatabaseException, InterruptedException {
    stats.nAcquiresWithContention++;
    hook430__wrappee__Latches();
  }

	
   private void  hook431__wrappee__Latches  () throws DatabaseException {
  }

	
  protected void hook431() throws DatabaseException {
    stats.nAcquiresNoWaiters++;
    hook431__wrappee__Latches();
  }

	
   private void  hook432__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }

	
  protected void hook432() throws DatabaseException, InterruptedException {
    stats.nAcquireSharedSuccessful++;
    hook432__wrappee__Latches();
  }

	
   private void  hook433__wrappee__Latches  () throws LatchNotHeldException {
  }

	
  protected void hook433() throws LatchNotHeldException {
    stats.nReleases++;
    hook433__wrappee__Latches();
  }
