...
public class FTSender_ESTest_scaffolding5 {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "it.yup.xmpp.FTSender"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FTSender_ESTest_scaffolding5.class.getClassLoader() ,
      "it.yup.util.RMSIndex",
      "it.yup.util.RMSIndex$Item",
      "it.yup.xmpp.IQResultListener",
      "it.yup.xmpp.FTSender$4",
      "it.yup.xmpp.FTSender$1",
      "it.yup.xmlstream.StreamEventListener",
      "it.yup.xmlstream.SocketStream",
      "it.yup.util.RMSIndex$Comparator",
      "it.yup.xmpp.Roster",
      "it.yup.xmpp.FTSender$2",
      "it.yup.util.Utils",
      ...
      "it.yup.xmpp.FTSender$5",
      "it.yup.xmlstream.BasicXmlStream",
      "it.yup.xmpp.FTSender$6",
      "it.yup.xmpp.Config",
