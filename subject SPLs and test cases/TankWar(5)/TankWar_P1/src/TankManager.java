...
abstract class TankManager$$TankWar extends MIDlet implements GameManager {
	...
	//	(new Maler(new TankManager())).tankErstellen();		//China_Type99.Maler.tankErstellen() - Space({P1,P2,P3,P5})
	//	(new TankManager()).malenkontrolle();	//Mars.Tool.init(TankManagerintintint) - Space({P1,P2,P3}), FeuerKraft.Tool.init(TankManagerintintint) - Space({P1,P3,P5}), Energie.Tool.init(TankManagerintintint) - Space({P1,P4})
