...
public class SoundPlayer_ESTest4   {
@BeforeClass
...
public static void exitEvoSuiteFramework() {
   ...
   * Goal 3. SoundPlayer.getInstance()LSoundPlayer;: I3 Branch 1 IFNONNULL L12 - false
   * Goal 4. Branch SoundPlayer.playMoveSound()V: root-Branch in context: SoundPlayer:playMoveSound()V
   * Goal 5. Branch SoundPlayer.getInstance()LSoundPlayer;: I3 Branch 1 IFNONNULL L12 - false in context: 
   * Goal 6. playMoveSound()V_java.lang.NoClassDefFoundError_IMPLICIT
   ...
   * Goal 13. SoundPlayer.playMoveSound()V: Line 36
   * Goal 14. [METHOD] SoundPlayer.getInstance()LSoundPlayer;
   * Goal 15. [METHOD] SoundPlayer.playMoveSound()V
   * Goal 16. [METHODNOEX] SoundPlayer.getInstance()LSoundPlayer;
   ...
   * Goal 5. playFireSound()V_java.lang.NoClassDefFoundError_IMPLICIT
   * Goal 6. SoundPlayer.<init>()V: Line 7
   * Goal 7. SoundPlayer.<init>()V: Line 9
   * Goal 8. SoundPlayer.playFireSound()V: Line 24
   * Goal 9. [METHOD] SoundPlayer.<init>()V
   * Goal 10. [METHOD] SoundPlayer.playFireSound()V
   * Goal 11. [METHODNOEX] SoundPlayer.<init>()V
   */
   ...
   * Goal 2. SoundPlayer.<init>()V: root-Branch
   * Goal 3. Branch SoundPlayer.playExplodeSound()V: root-Branch in context: SoundPlayer:playExplodeSound()V
   * Goal 4. Branch SoundPlayer.<init>()V: root-Branch in context: SoundPlayer:<init>()V
   * Goal 5. playExplodeSound()V_java.lang.NoClassDefFoundError_IMPLICIT
   * Goal 6. SoundPlayer.<init>()V: Line 7
   * Goal 7. SoundPlayer.<init>()V: Line 9
   * Goal 8. SoundPlayer.playExplodeSound()V: Line 30
   * Goal 9. [METHOD] SoundPlayer.<init>()V
   * Goal 10. [METHOD] SoundPlayer.playExplodeSound()V
   * Goal 11. [METHODNOEX] SoundPlayer.<init>()V
   */
   ...
   * Goal 5. Branch SoundPlayer.getInstance()LSoundPlayer;: I3 Branch 1 IFNONNULL L12 - false in context: 
   * Goal 6. playYeahSound()V_java.lang.NoClassDefFoundError_IMPLICIT
   * Goal 7. [Output]: SoundPlayer.getInstance()LSoundPlayer;:NonNull
   * Goal 8. SoundPlayer.<init>()V: Line 7
   * Goal 9. SoundPlayer.<init>()V: Line 9
   * Goal 10. SoundPlayer.getInstance()LSoundPlayer;: Line 12
   * Goal 11. SoundPlayer.getInstance()LSoundPlayer;: Line 13
   * Goal 12. SoundPlayer.getInstance()LSoundPlayer;: Line 15
   * Goal 13. SoundPlayer.playYeahSound()V: Line 54
   * Goal 14. [METHOD] SoundPlayer.getInstance()LSoundPlayer;
   * Goal 15. [METHOD] SoundPlayer.playYeahSound()V
   * Goal 16. [METHODNOEX] SoundPlayer.getInstance()LSoundPlayer;
   * Goal 17. Weak Mutation 0: SoundPlayer.getInstance()LSoundPlayer;:12 - ReplaceComparisonOperator != null -> = null
   */
   ...
   * Goal 2. SoundPlayer.<init>()V: root-Branch
   * Goal 3. SoundPlayer.getInstance()LSoundPlayer;: I3 Branch 1 IFNONNULL L12 - false
   * Goal 4. Branch SoundPlayer.playYessirSound()V: root-Branch in context: SoundPlayer:playYessirSound()V
   * Goal 5. Branch SoundPlayer.getInstance()LSoundPlayer;: I3 Branch 1 IFNONNULL L12 - false in context: 
   * Goal 6. playYessirSound()V_java.lang.NoClassDefFoundError_IMPLICIT
   * Goal 7. [Output]: SoundPlayer.getInstance()LSoundPlayer;:NonNull
   * Goal 8. SoundPlayer.<init>()V: Line 7
   * Goal 9. SoundPlayer.<init>()V: Line 9
   * Goal 10. SoundPlayer.getInstance()LSoundPlayer;: Line 12
   * Goal 11. SoundPlayer.getInstance()LSoundPlayer;: Line 13
   * Goal 12. SoundPlayer.getInstance()LSoundPlayer;: Line 15
   * Goal 13. SoundPlayer.playYessirSound()V: Line 48
   * Goal 14. [METHOD] SoundPlayer.getInstance()LSoundPlayer;
   * Goal 15. [METHOD] SoundPlayer.playYessirSound()V
   * Goal 16. [METHODNOEX] SoundPlayer.getInstance()LSoundPlayer;
   * Goal 17. Weak Mutation 0: SoundPlayer.getInstance()LSoundPlayer;:12 - ReplaceComparisonOperator != null -> = null
   */
