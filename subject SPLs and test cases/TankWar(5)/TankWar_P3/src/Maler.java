...
abstract class Maler$$Feuerkraft extends  Maler$$einfrieren  {
...
abstract class Maler$$M_240 extends  Maler$$Mars  {
...
abstract class Maler$$fuer_PC extends  Maler$$M_240  {
...
abstract class Maler$$Germany_Leopard extends  Maler$$Re_fuer_PC  {

	protected void tankErstellen(){
		super.tankErstellen();
		int x, y;
		//**Space({TankWar_P4, TankWar_P3, TankWar_P2}) delete
		x = GAME_WIDTH * 2 / 3 / 3;
		y = (int) (2.5 * x);
				
		//**Space({TankWar_P4, TankWar_P3, TankWar_P2}) add
		//x = GAME_WIDTH * 2 * 3 / 3;
		//y = (int) (2.5 / x);
