...
abstract class TankManager$$TankWar extends MIDlet implements GameManager {
	...
	//	(new Missile(new TankManager(), 1, 2, 3, 4, 5, 6, true, 8)).treffenErkennen();	//explodieren.Missile.explodieren() - Space({P3, P5})
		//Tool t = new Tool(new TankManager(), 1, 2, 3);	//Beschleunigung.Tool.init(TankManagerintintint) - Space({P2,P3})
...
abstract class TankManager$$Feuerkraft extends  TankManager$$einfrieren  {
...
abstract class TankManager$$Record extends  TankManager$$explodieren  {
