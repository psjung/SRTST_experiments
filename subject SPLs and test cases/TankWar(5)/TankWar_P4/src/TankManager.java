...
abstract class TankManager$$TankWar extends MIDlet implements GameManager {
	...
	//	(new Maler(new TankManager())).tankErstellen();		//Germany_Leopard.Maler.tankErstellen() - Space({P2,P3,P4)}
		//(new TankManager()).malenkontrolle();	//Re_fuer_PC.Maler.note(Vector) - Space({P1,P3,P4,P5}), Energie.Tool.init(TankManagerintintint) - Space({P1,P4})
...
abstract class TankManager$$Record extends  TankManager$$Energie  {
	...
	public TankManager$$Record (  ) { super(); }
