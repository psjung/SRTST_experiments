...
abstract class Tank$$Mars extends  Tank$$Bombe  {
...
abstract class Tank$$Image extends  Tank$$Mars  {
...
abstract class Tank$$Sound_fuer_pc extends  Tank$$Image  {
	 ...
	 * @param tankType
	 */
	public Tank$$Sound_fuer_pc ( TankManager tankManager, int x_Koordinate, int y_Koordinate, int tankType ) { super(tankManager, x_Koordinate, y_Koordinate, tankType); }
