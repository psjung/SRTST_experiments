...
abstract class Maler$$Mars extends  Maler$$Bombe  {
...
abstract class Maler$$USA_M1Abrams extends  Maler$$fuer_PC  {
	
	protected void tankErstellen(){
		super.tankErstellen();
		int x, y;
		//**Space({TankWar_P2, TankWar_P1}) delete
		x = GAME_WIDTH * 2 / 3 / 3;
		y = (int) (2.5 * x);
				
		//**Space({TankWar_P2, TankWar_P1}) add
		//x = GAME_WIDTH * 2 * 3 / 3;
		//y = (int) (2.5 / x);
