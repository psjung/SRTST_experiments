...
abstract class TankManager$$TankWar extends MIDlet implements GameManager {
	...
	public static void main(String[] args) {
		//(new Maler(new TankManager())).tankErstellen();		//Germany_Leopard.Maler.tankErstellen() - Space({P2,P3,P4)}, China_Type99.Maler.tankErstellen() - Space({P1,P2,P3,P5})
		//Tool t = new Tool(new TankManager(), 1, 2, 3);	//Bombe.Tool.init(TankManagerintintint) - Space({P2,P4,P5)}, Beschleunigung.Tool.init(TankManagerintintint) - Space({P2,P3})
		//new TankManager();
...
abstract class TankManager$$Mars extends  TankManager$$Bombe  {
