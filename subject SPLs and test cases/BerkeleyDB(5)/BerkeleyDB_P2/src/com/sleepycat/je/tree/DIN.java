 ...
 */
   private void  setDupCountLN__wrappee__base  (  ChildReference dupCountLNRef){
    this.dupCountLNRef=dupCountLNRef;
  }
 ...
 */
  void setDupCountLN(  ChildReference dupCountLNRef){
    ...
    setDupCountLN__wrappee__base(dupCountLNRef);
  }
...
@MethodObject static  class  DIN_updateDupCountLNRefAndNullTarget {
    ...
    protected long newSize;
     ...
     private void  hook614__wrappee__base  (){
    }

		
    protected void hook614(){
      oldSize=_this.getEntryInMemorySize(_this.dupCountLNRef.getKey(),_this.dupCountLNRef.getTarget());
      hook614__wrappee__base();
    }
