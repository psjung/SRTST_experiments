 ...
 */
  public long getTransactionId(){
   ...
   private void  hook611__wrappee__base  (  BIN fullBIN) throws DatabaseException {
  }

	
  protected void hook611(  BIN fullBIN) throws DatabaseException {
    fullBIN.releaseLatch();
    hook611__wrappee__base(fullBIN);
  }

	
   private void  hook612__wrappee__base  (  BIN fullBIN) throws DatabaseException {
  }

	
  protected void hook612(  BIN fullBIN) throws DatabaseException {
    fullBIN.latch();
    hook612__wrappee__base(fullBIN);
  }
