 ...
 */
  ...
  public void setTotalLoadBytes(  long totalLoadBytes){
   ...
   private boolean  load__wrappee__base  () throws IOException, DatabaseException {
  ...
  private byte[] readPrintableLine(  String line) throws DatabaseException {
   ...
   private void  hook835__wrappee__base  () throws IOException, DatabaseException {
  }
