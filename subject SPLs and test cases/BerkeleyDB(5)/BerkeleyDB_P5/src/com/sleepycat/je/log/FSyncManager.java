...
import com.sleepycat.je.log.FSyncManager.FSyncGroup; 
...
//        	  if (!fsyncDone) {
   ...
   private void  hook434__wrappee__FSync  (  EnvironmentImpl envImpl) throws DatabaseException {
  }
  ...
  protected void hook434(  EnvironmentImpl envImpl) throws DatabaseException {
    ...
    hook434__wrappee__FSync(envImpl);
  }

	
   private void  hook435__wrappee__FSync  () throws DatabaseException {
  }

	
  protected void hook435() throws DatabaseException {
    nFSyncRequests++;
    hook435__wrappee__FSync();
  }

	
   private void  hook436__wrappee__FSync  () throws DatabaseException {
  }
...
synchronized (this) {
    ...
    hook436__wrappee__FSync();
  }

	
   private void  hook437__wrappee__FSync  () throws DatabaseException {
  }

	
  protected void hook437() throws DatabaseException {
    nFSyncs++;
    hook437__wrappee__FSync();
  }
