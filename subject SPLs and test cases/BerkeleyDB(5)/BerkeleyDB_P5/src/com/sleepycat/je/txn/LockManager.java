...
synchronized (locker) {
  ...
  abstract protected LockAttemptResult attemptLock(  Long nodeId,  Locker locker,  LockType type,  boolean nonBlockingRequest) throws DatabaseException ;
   ...
   private LockAttemptResult  attemptLockInternal__wrappee__base  (  Long nodeId,  Locker locker,  LockType type,  boolean nonBlockingRequest,  int lockTableIndex) throws DatabaseException {
  ...
  protected LockAttemptResult attemptLockInternal(  Long nodeId,  Locker locker,  LockType type,  boolean nonBlockingRequest,  int lockTableIndex) throws DatabaseException {
    nRequests++;
    return attemptLockInternal__wrappee__base(nodeId,locker,type,nonBlockingRequest,lockTableIndex);
  }
...
static  class  LockAttemptResult {
   ...
   private void  hook770__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook770() throws DatabaseException {
    lockTableLatches=new Latch[nLockTables];
    hook770__wrappee__base();
  }

	
   private void  hook771__wrappee__base  (  EnvironmentImpl envImpl,  int i) throws DatabaseException {
  }
  ...
  protected void hook771(  EnvironmentImpl envImpl,  int i) throws DatabaseException {
    ...
    hook771__wrappee__base(envImpl,i);
  }

	
   private void  hook772__wrappee__base  (  boolean nonBlockingRequest) throws DeadlockException, DatabaseException {
  }
  ...
  protected void hook772(  boolean nonBlockingRequest) throws DeadlockException, DatabaseException {
    ...
    hook772__wrappee__base(nonBlockingRequest);
  }

	
   private void  hook773__wrappee__base  (  StringBuffer sb,  int i) throws DatabaseException {
    dumpToStringNoLatch(sb,i);
  }
  ...
  protected void hook773(  StringBuffer sb,  int i) throws DatabaseException {
   ...
   private void  hook774__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook774() throws DatabaseException {
    nRequests=0;
    nWaits=0;
    hook774__wrappee__base();
  }

	
   private void  hook775__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook775() throws DatabaseException {
   ...
   private void  hook776__wrappee__base  (  LockStats stats,  Map lockTable){
  }

	
  protected void hook776(  LockStats stats,  Map lockTable){
    stats.accumulateNTotalLocks(lockTable.size());
    hook776__wrappee__base(stats,lockTable);
  }

	
   private void  hook777__wrappee__base  (  LockStats stats,  Lock lock){
  }
  ...
  protected void hook777(  LockStats stats,  Lock lock){
    ...
    hook777__wrappee__base(stats,lock);
  }

	
   private void  hook778__wrappee__base  (  LockStats stats,  LockInfo info){
  }
  ...
  protected void hook778(  LockStats stats,  LockInfo info){
    ...
    hook778__wrappee__base(stats,info);
  }

	
   private void  hook779__wrappee__base  (  DbConfigManager configMgr) throws DatabaseException {
  }
  ...
  protected void hook779(  DbConfigManager configMgr) throws DatabaseException {
    ...
    hook779__wrappee__base(configMgr);
  }

	
   private void  hook780__wrappee__base  (  int lockTableIndex) throws DatabaseException {
  }
  ...
  protected void hook780(  int lockTableIndex) throws DatabaseException {
    ...
    hook780__wrappee__base(lockTableIndex);
  }

	
   private void  hook781__wrappee__base  (  int lockTableIndex) throws DatabaseException {
  }
  ...
  protected void hook781(  int lockTableIndex) throws DatabaseException {
    ...
    hook781__wrappee__base(lockTableIndex);
  }
...
@MethodObject static  class  LockManager_lockStat {
    ...
    protected LatchStats latchStats;
     ...
     private void  hook769__wrappee__Statistics  () throws DatabaseException {
    }
