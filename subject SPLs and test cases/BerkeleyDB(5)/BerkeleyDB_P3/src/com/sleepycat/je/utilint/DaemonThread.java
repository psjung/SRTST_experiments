...
synchronized (synchronizer) {
  ...
  public String toString(){
   ...
   private void  addToQueue__wrappee__base  (  Object o) throws DatabaseException {
    workQueue.add(o);
    wakeup();
  }
  ...
  public void addToQueue(  Object o) throws DatabaseException {
    ...
    addToQueue__wrappee__base(o);
    workQueueLatch.release();
  }

	
   private int  getQueueSize__wrappee__base  () throws DatabaseException {
  ...
  public int getQueueSize() throws DatabaseException {
    workQueueLatch.acquire();
    int result=getQueueSize__wrappee__base();
    workQueueLatch.release();
    return result;
  }
 ...
 */
  public int getNWakeupRequests(){
   ...
   private void  hook856__wrappee__base  (  String name,  EnvironmentImpl env){
  }

	
  protected void hook856(  String name,  EnvironmentImpl env){
    workQueueLatch=LatchSupport.makeLatch(name + " work queue",env);
    hook856__wrappee__base(name,env);
  }

	
   private void  hook857__wrappee__base  () throws InterruptedException, Exception {
  }

	
  protected void hook857() throws InterruptedException, Exception {
    workQueueLatch.release();
    hook857__wrappee__base();
  }

	
   private void  hook858__wrappee__base  () throws InterruptedException, Exception {
  }
