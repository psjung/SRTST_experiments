...
@MethodObject static  class  FileReader_readNextEntry {
    ...
    protected void hook468() throws DatabaseException, IOException {
     ...
     private void  hook474__wrappee__base  () throws DatabaseException, IOException, EOFException {
    }
    ...
    protected void hook474() throws DatabaseException, IOException, EOFException {
      ...
      hook474__wrappee__base();
    }

		
     private void  hook475__wrappee__base  () throws DatabaseException, IOException, EOFException {
    }
    ...
    protected void hook475() throws DatabaseException, IOException, EOFException {
      ...
      hook475__wrappee__base();
    }

		
     private void  hook476__wrappee__base  () throws DatabaseException, IOException, EOFException {
    }
  ...
  protected void hook471(  FileHandle fileHandle) throws DatabaseException, EOFException {
   ...
   private void  hook472__wrappee__base  () throws IOException, DatabaseException {
  }
  ...
  protected void hook472() throws IOException, DatabaseException {
    ...
    hook472__wrappee__base();
  }

	
   private void  hook473__wrappee__base  (  EnvironmentImpl env) throws IOException, DatabaseException {
  }
