...
private static  class  BINSearch {
  ...
  protected void hook392(  int binQueueSize) throws DatabaseException {
   ...
   private void  hook393__wrappee__INCompressor  () throws DatabaseException {
  }

	
  protected void hook393() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook393__wrappee__INCompressor();
  }

	
   private void  hook394__wrappee__INCompressor  (  BIN foundBin) throws DatabaseException {
  }

	
  protected void hook394(  BIN foundBin) throws DatabaseException {
    foundBin.releaseLatch();
    hook394__wrappee__INCompressor(foundBin);
  }

	
   private void  hook395__wrappee__INCompressor  () throws DatabaseException {
  }

	
  protected void hook395() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook395__wrappee__INCompressor();
  }

	
   private void  hook396__wrappee__INCompressor  (  BIN bin,  BINReference binRef,  boolean empty,  boolean requeued,  byte[] dupKey,  boolean isDBIN) throws DatabaseException {
    int nCursors=bin.nCursors();
    if (nCursors > 0) {
      addBinRefToQueue(binRef,false);
      requeued=true;
  ...
  protected void hook396(  BIN bin,  BINReference binRef,  boolean empty,  boolean requeued,  byte[] dupKey,  boolean isDBIN) throws DatabaseException {
    try {
      hook396__wrappee__INCompressor(bin,binRef,empty,requeued,dupKey,isDBIN);
    }
  finally {
      bin.releaseLatch();
    }
   ...
   private void  hook397__wrappee__INCompressor  (  byte[] mainKey,  byte[] dupKey,  Tree tree,  DIN duplicateRoot,  DBIN duplicateBin,  BIN bin) throws DatabaseException {
  ...
  protected void hook397(  byte[] mainKey,  byte[] dupKey,  Tree tree,  DIN duplicateRoot,  DBIN duplicateBin,  BIN bin) throws DatabaseException {
    try {
      hook397__wrappee__INCompressor(mainKey,dupKey,tree,duplicateRoot,duplicateBin,bin);
    }
   ...
   private void  hook398__wrappee__INCompressor  (  IN in) throws DatabaseException {
  }

	
  protected void hook398(  IN in) throws DatabaseException {
    assert in.isLatchOwner();
    hook398__wrappee__INCompressor(in);
  }

	
   private void  hook399__wrappee__INCompressor  (  BINSearch binSearch) throws DatabaseException {
  }
  ...
  protected void hook399(  BINSearch binSearch) throws DatabaseException {
    ...
    hook399__wrappee__INCompressor(binSearch);
  }

	
   private void  hook400__wrappee__INCompressor  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook400(  BIN bin) throws DatabaseException {
    bin.releaseLatch();
    hook400__wrappee__INCompressor(bin);
  }

	
   private void  hook401__wrappee__INCompressor  (  DIN duplicateRoot,  BIN bin) throws DatabaseException {
  }
  ...
  protected void hook401(  DIN duplicateRoot,  BIN bin) throws DatabaseException {
    duplicateRoot.latch();
    bin.releaseLatch();
    hook401__wrappee__INCompressor(duplicateRoot,bin);
  }

	
   private void  hook402__wrappee__INCompressor  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook402(  BIN bin) throws DatabaseException {
    bin.releaseLatch();
    hook402__wrappee__INCompressor(bin);
  }

	
   private void  hook403__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook403() throws DatabaseException {
   ...
   private void  hook404__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook404() throws DatabaseException {
   ...
   private void  hook405__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook405() throws DatabaseException {
   ...
   private void  hook406__wrappee__INCompressor  () throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }
  ...
  protected void hook406() throws DatabaseException, NodeNotEmptyException, CursorsExistException {
   ...
   private void  hook407__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook407() throws DatabaseException {
   ...
   private void  hook408__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook408() throws DatabaseException {
   ...
   private void  hook409__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook409() throws DatabaseException {
   ...
   private void  hook410__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook410() throws DatabaseException {
   ...
   private void  hook411__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook411() throws DatabaseException {
   ...
   private void  hook412__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook412() throws DatabaseException {
   ...
   private void  hook413__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook413() throws DatabaseException {
   ...
   private void  hook414__wrappee__INCompressor  () throws DatabaseException {
  }
  ...
  protected void hook414() throws DatabaseException {
   ...
   private boolean  hook415__wrappee__INCompressor  (  BINSearch binSearch,  boolean close) throws DatabaseException {
    return close;
  }
  ...
  protected boolean hook415(  BINSearch binSearch,  boolean close) throws DatabaseException {
    ...
    return hook415__wrappee__INCompressor(binSearch,close);
  }
...
synchronized (binRefQueueSync) {
   ...
   private void  hook390__wrappee__Derivative_Verifier_INCompressor  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook390(  BIN bin) throws DatabaseException {
    bin.releaseLatch();
    hook390__wrappee__Derivative_Verifier_INCompressor(bin);
  }
