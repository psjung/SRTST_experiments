 ...
 */
  private void checkArgsNoValRequired(  DatabaseEntry key,  DatabaseEntry pKey,  DatabaseEntry data){
   ...
   private void  hook65__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook65() throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.delete: ",null);
    hook65__wrappee__base();
  }

	
   private void  hook66__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook66(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getCurrent: ",lockMode);
    hook66__wrappee__base(lockMode);
  }

	
   private void  hook67__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook67(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getFirst: ",lockMode);
    hook67__wrappee__base(lockMode);
  }

	
   private void  hook68__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook68(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getLast: ",lockMode);
    hook68__wrappee__base(lockMode);
  }

	
   private void  hook69__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook69(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getNext: ",lockMode);
    hook69__wrappee__base(lockMode);
  }

	
   private void  hook70__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook70(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getNextDup: ",lockMode);
    hook70__wrappee__base(lockMode);
  }

	
   private void  hook71__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook71(  LockMode lockMode) throws DatabaseException {
    ...
    hook71__wrappee__base(lockMode);
  }

	
   private void  hook72__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook72(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getPrev: ",lockMode);
    hook72__wrappee__base(lockMode);
  }

	
   private void  hook73__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook73(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getPrevDup: ",lockMode);
    hook73__wrappee__base(lockMode);
  }

	
   private void  hook74__wrappee__base  (  LockMode lockMode) throws DatabaseException {
  }

	
  protected void hook74(  LockMode lockMode) throws DatabaseException {
    trace(Level.FINEST,"SecondaryCursor.getPrevNoDup: ",lockMode);
    hook74__wrappee__base(lockMode);
  }

	
   private void  hook75__wrappee__base  (  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook75(  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
    ...
    hook75__wrappee__base(key,lockMode);
  }

	
   private void  hook76__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook76(  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook76__wrappee__base(key,data,lockMode);
  }

	
   private void  hook77__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook77(  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook77__wrappee__base(key,data,lockMode);
  }

	
   private void  hook78__wrappee__base  (  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook78(  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook78__wrappee__base(key,data,lockMode);
  }
