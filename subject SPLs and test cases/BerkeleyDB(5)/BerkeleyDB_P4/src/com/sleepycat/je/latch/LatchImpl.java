...
static private  class  LatchWaiter {
   ...
   private void  hook422__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }

	
  protected void hook422() throws DatabaseException, InterruptedException {
    stats.nAcquiresSelfOwned++;
    hook422__wrappee__Latches();
  }

	
   private void  hook423__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }
  ...
  protected void hook423() throws DatabaseException, InterruptedException {
   ...
   private void  hook424__wrappee__Latches  () throws DatabaseException, InterruptedException {
  }

	
  protected void hook424() throws DatabaseException, InterruptedException {
    stats.nAcquiresWithContention++;
    hook424__wrappee__Latches();
  }

	
   private void  hook425__wrappee__Latches  () throws LatchException {
  }
  ...
  protected void hook425() throws LatchException {
   ...
   private void  hook426__wrappee__Latches  () throws LatchException {
  }

	
  protected void hook426() throws LatchException {
    stats.nAcquireNoWaitSuccessful++;
    hook426__wrappee__Latches();
  }

	
   private void  hook427__wrappee__Latches  () throws LatchException {
  }
  ...
  protected void hook427() throws LatchException {
   ...
   private void  hook428__wrappee__Latches  (){
  }
