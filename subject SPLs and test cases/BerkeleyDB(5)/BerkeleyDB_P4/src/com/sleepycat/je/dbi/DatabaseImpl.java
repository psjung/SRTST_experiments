...
@MethodObject static  class  DatabaseImpl_preload {
    ...
    protected SortedLSNTreeWalker walker;
     ...
     private void  hook287__wrappee__base  () throws DatabaseException {
      walker.walk();
    }
   ...
   private void  hook288__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook288() throws DatabaseException {
    deleteState=NOT_DELETED;
    hook288__wrappee__base();
  }

	
   private void  hook289__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook289() throws DatabaseException {
    deleteState=NOT_DELETED;
    hook289__wrappee__base();
  }
