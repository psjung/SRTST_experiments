 ...
 */
  public String toString(){
   ...
   private void  hook760__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }
  ...
  protected void hook760(  MemoryBudget mb,  int lockTableIndex){
    ...
    hook760__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook761__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }

	
  protected void hook761(  MemoryBudget mb,  int lockTableIndex){
    mb.updateLockMemoryUsage(MemoryBudget.LOCKINFO_OVERHEAD,lockTableIndex);
    hook761__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook762__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }
  ...
  protected void hook762(  MemoryBudget mb,  int lockTableIndex){
    ...
    hook762__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook763__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }

	
  protected void hook763(  MemoryBudget mb,  int lockTableIndex){
    mb.updateLockMemoryUsage(REMOVE_LOCKINFO_OVERHEAD,lockTableIndex);
    hook763__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook764__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }

	
  protected void hook764(  MemoryBudget mb,  int lockTableIndex){
    mb.updateLockMemoryUsage(MemoryBudget.LOCKINFO_OVERHEAD,lockTableIndex);
    hook764__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook765__wrappee__base  (  MemoryBudget mb,  int lockTableIndex,  boolean removed){
  }
  ...
  protected void hook765(  MemoryBudget mb,  int lockTableIndex,  boolean removed){
    ...
    hook765__wrappee__base(mb,lockTableIndex,removed);
  }

	
   private void  hook766__wrappee__base  (  MemoryBudget mb,  int lockTableIndex,  LockInfo flushedInfo){
  }
  ...
  protected void hook766(  MemoryBudget mb,  int lockTableIndex,  LockInfo flushedInfo){
    ...
    hook766__wrappee__base(mb,lockTableIndex,flushedInfo);
  }

	
   private void  hook767__wrappee__base  (  MemoryBudget mb,  int lockTableIndex){
  }

	
  protected void hook767(  MemoryBudget mb,  int lockTableIndex){
    mb.updateLockMemoryUsage(REMOVE_LOCKINFO_OVERHEAD,lockTableIndex);
    hook767__wrappee__base(mb,lockTableIndex);
  }

	
   private void  hook768__wrappee__base  (  MemoryBudget mb,  int lockTableIndex,  int numRemovedLockInfos) throws DatabaseException {
  }
  ...
  protected void hook768(  MemoryBudget mb,  int lockTableIndex,  int numRemovedLockInfos) throws DatabaseException {
    ...
    hook768__wrappee__base(mb,lockTableIndex,numRemovedLockInfos);
  }
