      ...
      }
{
    ...
    protected void hook544() throws DatabaseException {
     ...
     private void  hook517__wrappee__LoggingFinest  () throws DatabaseException {
    }

		
    protected void hook517() throws DatabaseException {
      sb.append("size interval=").append(useBytesInterval);
      hook517__wrappee__LoggingFinest();
    }
        ...
        level=new Integer(in.getLevel());
{
  ...
  public String toString(){
	  ...
	  //**Space({P3,P4,P5,P6}) - delete
	    return sb.toString();
	  //**Space({P3,P4,P5,P6}) - add
//	    return null;
	  }
 ...
 */
  ...
  private void trace(  EnvironmentImpl envImpl,  String invokingSource,  boolean success){
   ...
   private void  hook516__wrappee__LoggingConfig  (  StringBuffer sb){
  }
  ...
  protected void hook516(  StringBuffer sb){
    ...
    hook516__wrappee__LoggingConfig(sb);
  }
