...
@MethodObject static  class  FileManager_readFromFile {
  ...
  protected void hook454(  FileHandle fileHandle) throws LogException, DatabaseException {
   ...
   private void  hook456__wrappee__base  (  DbConfigManager configManager) throws DatabaseException {
  }
  ...
  protected void hook456(  DbConfigManager configManager) throws DatabaseException {
    ...
    hook456__wrappee__base(configManager);
  }
 ...
 */
  ...
  //**Space({P4,P5,P7}) - delete
  private long chunkedNIOSize=0;
//**Space({P4,P5,P7}) - add
//  private static long chunkedNIOSize=0;
