...
@MethodObject static  class  LogManager_getLogEntryFromLogSource {
    ...
    protected void hook507() throws DatabaseException, ClosedChannelException, Exception {
     ...
     private void  hook508__wrappee__base  () throws DatabaseException, ClosedChannelException, Exception {
    }

		
    protected void hook508() throws DatabaseException, ClosedChannelException, Exception {
      _this.nRepeatFaultReads++;
      hook508__wrappee__base();
    }
   ...
   private void  hook498__wrappee__base  (  EnvironmentImpl envImpl) throws DatabaseException {
  }

	
  protected void hook498(  EnvironmentImpl envImpl) throws DatabaseException {
    checkpointMonitor=new CheckpointMonitor(envImpl);
    hook498__wrappee__base(envImpl);
  }

	
   private void  hook499__wrappee__base  (  LogResult logResult) throws DatabaseException {
  }
  ...
  protected void hook499(  LogResult logResult) throws DatabaseException {
    ...
    hook499__wrappee__base(logResult);
  }

	
   private boolean  hook500__wrappee__base  (  LoggableObject item,  int entrySize,  boolean wakeupCheckpointer) throws IOException, DatabaseException {
  ...
  protected boolean hook500(  LoggableObject item,  int entrySize,  boolean wakeupCheckpointer) throws IOException, DatabaseException {
    ...
    return hook500__wrappee__base(item,entrySize,wakeupCheckpointer);
  }
  ...
  protected void hook505(  DbConfigManager configManager) throws DatabaseException {
   ...
   private void  hook509__wrappee__base  () throws IOException, DatabaseException, Exception {
  }

	
  protected void hook509() throws IOException, DatabaseException, Exception {
    nTempBufferWrites++;
    hook509__wrappee__base();
  }
  ...
  public void loadStats(  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
   ...
   private void  hook497__wrappee__Statistics  (  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
  }
  ...
  protected void hook497(  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
    ...
    hook497__wrappee__Statistics(config,stats);
  }
