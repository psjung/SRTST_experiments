...
public class SPLTestSelectionSystem_Wiper {	
	...
	public SPLTestSelectionSystem_Wiper(){
	...
	public static void main(String args[]) throws IOException{
		SPLTestSelectionSystem_Wiper system = new SPLTestSelectionSystem_Wiper();
		system.start(args);	
	}
...
//		impactedTestSuiteId = this.getImpactedTestSuite();
		...
		//	System.out.println("The number of executions: "+ executionNumber + "(" + sizeOfTCs_naive + ")");
			...
			File f1 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Wiper_P1 CoverageInfo_c.txt");
			File f2 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Wiper_P2 CoverageInfo_c.txt");
			File f3 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Wiper_P3 CoverageInfo_c.txt");
			File f4 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Wiper_P4 CoverageInfo_c.txt");
			...
			listString.add(new String[]{"WiperFamily", "Sensor"});
			listString.add(new String[]{"Wiper"});
			listString.add(new String[]{"Sensor", "Wiper"});
			listString.add(new String[]{"WiperFamily"});
			listString.add(new String[]{"Sensor"});
			listString.add(new String[]{"Wiper"});
			listString.add(new String[]{"WiperFamily"});
			listString.add(new String[]{""});
			listString.add(new String[]{""});
			listString.add(new String[]{"WiperFamily", "Wiper"});
			...
			listString.add(new String[]{"Wiper"});
			listString.add(new String[]{""});
			listString.add(new String[]{"WiperFamily", "Sensor", "Wiper"});
			listString.add(new String[]{""});
			listString.add(new String[]{""});
			listString.add(new String[]{"Sensor"});
			listString.add(new String[]{""});
			...
			//1: heavy, 2: little, heavy, 3: off, manualOn, permWipe, intvOn, slowWipe, 4: fastWipe
			...
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(4))));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(4))));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(1,2,3,4))));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList())));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(1))));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(4))));
			variablePartChanges.add(func(new ArrayList<Integer>(Arrays.asList(2))));
	...
	public HashSet<HashSet<String>> func(ArrayList<Integer> list){
		...
		for(Integer i: list){
			if(i == 1){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Wiper_P3","Wiper_P4"))));
			}
			else if(i == 2){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Wiper_P2","Wiper_P4"))));
			}
			else if(i == 3){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Wiper_P3","Wiper_P1"))));
			}
			else if(i == 4){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Wiper_P2","Wiper_P1"))));
			}
			else if(i == 5){
