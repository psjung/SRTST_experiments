...
public class SPLTestSelectionSystem_Prevayler {	
	...
	public SPLTestSelectionSystem_Prevayler(){
	...
	public static void main(String args[]) throws IOException{
		SPLTestSelectionSystem_Prevayler system = new SPLTestSelectionSystem_Prevayler();
		system.start(args);	
	}
	...
	public void start(String args[]) throws IOException{
		...
		try{
			...
			File f1 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Prevayler_P1 CoverageInfo_c.txt");
			File f2 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Prevayler_P2 CoverageInfo_c.txt");
			File f3 = new File("C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\test1\\Prevayler_P3 CoverageInfo_c.txt");
...
//			listString.add(new String[]{"FileLocker", "POBox", "CentralPublisher"});
			...
			/*	HashSet<HashSet<String>> spaceToBeInstantiation = new HashSet<HashSet<String>>(); 
				...
				//HashSet<HashSet<String>> hshs = Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P1","Prevayler_P2","Prevayler_P3")));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(5,8))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(5,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,5))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,8,9))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(5,8,9))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(9))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,9))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(9))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,5,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,10))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,7))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(5,7,9))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,7,8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,5))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,5))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(8))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,3,10))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,3,10))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,3))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(5))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,7))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(3,4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(7))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,2,4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2,4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,1))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(1))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList())));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(1))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(1))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(4,1,2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(2))));
...
//						impactedTestSuiteId.addAll(func(new ArrayList<Integer>(Arrays.asList(1))));
	...
	public HashSet<HashSet<String>> func(ArrayList<Integer> list){
		...
		for(Integer i: list){
			if(i == 1){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P01111","Prevayler_P10111","Prevayler_P11011","Prevayler_P11101","Prevayler_P11111"))));
				//ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P2","Prevayler_P3"))));
			}
			else if(i == 2){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P10111","Prevayler_P11011","Prevayler_P11101","Prevayler_P11111"))));
				//ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P1","Prevayler_P3"))));
			}
			else if(i == 3){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P01111","Prevayler_P11011","Prevayler_P11101","Prevayler_P11111"))));
				//ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P1", "Prevayler_P2", "Prevayler_P3"))));
			}
			else if(i == 4){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P01111","Prevayler_P10111","Prevayler_P11101","Prevayler_P11111"))));
				//ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P2","Prevayler_P1"))));
			}
			else if(i == 5){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P01111","Prevayler_P10111","Prevayler_P11011","Prevayler_P11111"))));
			}
			else if(i == 6){
				ret.addAll(Util.powerSet(new HashSet<String>(Arrays.asList("Prevayler_P01111","Prevayler_P10111","Prevayler_P11011","Prevayler_P11101","Prevayler_P11111"))));
			}
