...
public class TCPTGenForVendingMachine {
	...
	public static void main(String[] args) throws IOException{
		...
		outFile = new File("C:/Users/soo/Desktop/eclipse-java-mars-2-win32-x86_64/SPLTestSelection/VendingMachineV1_TCs.xml");
		...
		writer.write("\t\t<name>VendingMachineV1_P1</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("VendingMachineV1_P1", "evosuite-tests"));
		...
		writer.write("\t<Product>\r\n");
		writer.write("\t\t<name>VendingMachineV1_P2</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("VendingMachine_P2", "evosuite-tests"));
		writer.write(TCs.toString().replace("[", "").replace("]", ""));
		...
		writer.write("\t<Product>\r\n");
		writer.write("\t\t<name>VendingMachineV1_P3</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("VendingMachine_P3", "evosuite-tests"));
		writer.write(TCs.toString().replace("[", "").replace("]", ""));
		...
		writer.write("\t<Product>\r\n");
		writer.write("\t\t<name>VendingMachineV1_P4</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("VendingMachine_P4", "evosuite-tests"));
		writer.write(TCs.toString().replace("[", "").replace("]", ""));
