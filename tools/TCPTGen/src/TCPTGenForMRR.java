...
public class TCPTGenForMRR {
	...
	public static void main(String[] args) throws IOException{
		...
		outFile = new File("C:/Users/soo/Desktop/eclipse-java-mars-2-win32-x86_64/SPLTestSelection/MRR_TCs.xml");
		...
		writer.write("\t\t<name>MRR3_P1</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("MRR3_P1", "evosuite-tests1"));
		TCs.addAll(allTCs("MRR3_P1", "evosuite-tests2"));
		TCs.addAll(allTCs("MRR3_P1", "evosuite-tests3"));
		...
		writer.write("\t<Product>\r\n");
		writer.write("\t\t<name>MRR3_P2</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("MRR3_P2", "evosuite-tests1"));
		TCs.addAll(allTCs("MRR3_P2", "evosuite-tests2"));
		TCs.addAll(allTCs("MRR3_P2", "evosuite-tests3"));
		writer.write(TCs.toString().replace("[", "").replace("]", ""));
		...
		writer.write("\t<Product>\r\n");
		writer.write("\t\t<name>MRR3_P3</name>\r\n");
		writer.write("\t\t<TestCases>");
		TCs.addAll(allTCs("MRR3_P3", "evosuite-tests1"));
		TCs.addAll(allTCs("MRR3_P3", "evosuite-tests2"));
		TCs.addAll(allTCs("MRR3_P3", "evosuite-tests3"));
		writer.write(TCs.toString().replace("[", "").replace("]", ""));
