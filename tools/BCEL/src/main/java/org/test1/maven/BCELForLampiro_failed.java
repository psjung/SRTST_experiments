...
public class BCELForLampiro_failed {
	static File d = new File("C:\\Users\\soo\\Downloads\\eclipse-java-mars-2-win32-x86_64\\Lampiro_P1\\bin");
	...
	public static void invokeAllMethods(File file) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException, IOException{
       ...
       //    System.out.println(path);
		    ...
		    try {
		    	ClassPathRepository classPathRepository = new ClassPathRepository(new org.apache.bcel.util.ClassPath("C:\\Users\\soo\\Downloads\\eclipse-java-mars-2-win32-x86_64\\Lampiro_P1\\bin"));
